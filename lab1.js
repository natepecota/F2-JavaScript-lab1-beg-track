...
//assert('lions' === 'lions', "'lions' equals 'lions' so this assert will pass.");
//assert('lions' === 'hyenas', "'lions' does not euqal 'hyenas' so this assert will not pass.");
...
var getFavorite = Math.floor(Math.random() * favoriteAnimals.length);
nextAnimal = favoriteAnimals[getFavorite];
